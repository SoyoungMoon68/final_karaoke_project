                    ...
                    <table class="table form">
                        ...
                        <tbody>
                            <tr>
                                <th>지점 번호</th>
                                <td>
                                    <input type="text" name="storeId"                        id="storeId"                        value="<c:out value="${resultObject.grpCd                         }"/>" title="그룹 코드"                    maxlength="10"   class="w-full" />
                                </td>
                                <th>지점 이</th>
                                <td>
                                    <input type="text" name="storeName"                      id="storeName"                      value="<c:out value="${resultObject.grpCdNm                       }"/>" title="그룹 코드 명"                 maxlength="40"   class="w-full" />
                                </td>
                            </tr>
                            <tr>
                                <th>운영 날짜</th>
                                <td colspan="3">
                                    <textarea          name="runYmd"                     id="runYmd"                                                                                             title="그룹 코드 내용"               maxlength="1000" class="w-full" onKeyUp="setMaxLength();" ><c:out value="${resultObject.grpCdCtt}"/></textarea>
                                </td>
                            </tr>
                            <%-- <tr>
                                <th>유효 일자</th>
