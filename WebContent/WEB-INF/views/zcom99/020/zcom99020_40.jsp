...
<script type="text/javascript">
    ...
    function requestPage(pageNo) {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Zcom.ACTION_ZCOM99020_40 %>";
    ...
    function requestDtl(menuId) {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Zcom.ACTION_ZCOM99020_41 %>" + getParam();
    ...
    function requestSave() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Zcom.ACTION_ZCOM99020_00 %>";
    ...
    function requestDel() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Zcom.ACTION_ZCOM99020_80 %>";
