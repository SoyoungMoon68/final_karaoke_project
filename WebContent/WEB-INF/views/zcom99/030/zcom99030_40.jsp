...
<script type="text/javascript">
    ...
    function requestPage(pageNo) {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Zcom.ACTION_ZCOM99030_40 %>";
     ...
     *  상세검색
     **************************************************************************/
    function requestDtl(userNum) {
        if ( !chkDtl() ) {
            return false;
        }

        document.getElementById("userNum").value = userNum;
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Zcom.ACTION_ZCOM99030_41 %>" + getParam();
    ...
    function requestSave() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Zcom.ACTION_ZCOM99030_00 %>";
...
//        if ( isEmptyObject(document.getElementById(Trim("coId                          ")), Trim("업체 ID                       ")) ) return false;
    ...
    function requestDel() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Zcom.ACTION_ZCOM99030_80 %>";
    ...
    function downloadExcel() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Zcom.ACTION_ZCOM99030_70 %>";
    ...
    function initUserPwd() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Zcom.ACTION_ZCOM99030_02 %>" + getParam();
            ...
            <jsp:include page="/include/zcom/menu/naviMenu.jsp" />
                ...
                <div class="bodyarea">
                    ...
                    <table class="table list">
                        ...
                        <tr style="cursor:pointer;" onclick="requestDtl('<c:out value="${row.userNum}"/>');">
                            ...
                            <td class="tx-center"><c:out value="${row.userAuthCd                    }"/></td>
