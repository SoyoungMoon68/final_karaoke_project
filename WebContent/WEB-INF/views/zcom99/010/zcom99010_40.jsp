...
<script type="text/javascript">
    ...
    function requestPage(pageNo) {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Zcom.ACTION_ZCOM99010_40 %>";
    ...
    function requestDtl(grpCd) {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Zcom.ACTION_ZCOM99010_41 %>" + getParam();
    ...
    function requestSave() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Zcom.ACTION_ZCOM99010_00 %>";
    ...
    function requestDel() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Zcom.ACTION_ZCOM99010_80 %>";
    ...
    function openCd() {
        ...
        var action = ctx + "/" + "<%= ActionConstants_Zcom.ACTION_ZCOM99011_40 %>" + getParam();
                    ...
                    <div class="filter">
                        <div class="form-group">
                            <div class="input-group">
                                <strong>그룹 코드123123123123</strong>
                                <p>
