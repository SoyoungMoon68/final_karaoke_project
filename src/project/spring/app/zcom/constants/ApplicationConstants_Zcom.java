...
//    public static final String DOMAIN                 = ":8080/project/"            ;  // 도메인
    ...
    public static final String TEMP_DIR_PATH         = "/PROJECT/IO/temp/project/"               ;  // temp
    public static final String UPLOAD_DIR_PATH       = "/PROJECT/IO/project/uploadFile/"         ;  // 파일저장경로
    public static final String UPLOAD_EXCEL_PATH     = "/PROJECT/IO/project/excel/uploadFile/"   ;  // 파일저장경로
    public static final String DOWNLOAD_EXCEL_PATH   = "/PROJECT/IO/project/excel/downloadFile/" ;  // 파일저장경로
